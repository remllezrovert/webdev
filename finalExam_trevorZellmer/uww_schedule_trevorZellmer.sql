...
--
-- Host: localhost
-- Generation Time: Dec 10, 2024 at 07:45 PM
...
CREATE TABLE `uww_schedule` (
  ...
  `instructor` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `section` int(11) NOT NULL,
  `days` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL,
  `time` varchar(30) NOT NULL,
  `location` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL
